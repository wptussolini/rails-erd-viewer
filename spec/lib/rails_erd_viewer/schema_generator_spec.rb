...
RSpec.describe RailsErdViewer::SchemaGenerator do
  ...
  describe '.add_table_to_file' do
    let(:columns) do
      [
        instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'id', type: :integer, null: false, default: nil),
        instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'name', type: :string, null: false, default: nil),
        instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'email', type: :string, null: true, default: nil)
      ]
    end
  ...
  describe '.add_columns_to_file' do
    let(:columns) do
      [
        instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'id', type: :integer, null: false, default: nil),
        instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'title', type: :string, null: false, default: nil),
        instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'description', type: :text, null: true, default: nil)
      ]
    end
  ...
  describe '.add_column_to_file' do
    context 'when column has NOT NULL constraint' do
      it 'writes column definition without default value' do
        column = instance_double(ActiveRecord::ConnectionAdapters::Column, name: 'title', type: :string, null: false, default: nil)
